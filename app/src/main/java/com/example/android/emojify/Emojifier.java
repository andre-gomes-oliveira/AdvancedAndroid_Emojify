...
class Emojifier {
    ...
    private static void whichEmoji(Face face){
        ...
        final double constraintSmiling = 0.5;
        final double constraintLeftEye = 0.5;
        final double constraintRightEye = 0.5;
        ...
        boolean isSmiling = face.getIsSmilingProbability() > constraintSmiling;
        boolean isLeftEye = face.getIsLeftEyeOpenProbability() > constraintLeftEye;
        boolean isRightEye = face.getIsRightEyeOpenProbability() > constraintRightEye;
        ...
        if(isSmiling) {
            ...
            }  else if(isRightEye && !isLeftEye){
                emoji = Emoji.TIGHT_WINK_FROWNING;
            } else if (isLeftEye){
    ...
    public enum Emoji {
        SMILING, FROWNING, LEFT_WINK, RIGHT_WINK,
        LEFT_WINK_FROWNING, TIGHT_WINK_FROWNING,
        CLOSED_EYES_SMILING, CLOSED_EYES_FROWNING
    }
}
